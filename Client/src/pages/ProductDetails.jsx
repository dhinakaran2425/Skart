    ...
    return product && (
        <div className="mt-35">
            <p>
                ...
                <span className="text-purple-500"> {product.name}</span>
            </p>
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <button
                            ...
                            className="w-full py-3.5 cursor-pointer font-medium bg-purple-500 text-white hover:bg-purple-600 transition"
                        >
                            Buy now
                        </button>
                    </div>
            ...
            <div className='flex flex-col items-center mt-20'>
                <div className='flex flex-col items-center w-max'>
                    ...
                    <div className='w-20 h-0.5 bg-purple-500 rounded-full mt-2'></div>
                </div>
